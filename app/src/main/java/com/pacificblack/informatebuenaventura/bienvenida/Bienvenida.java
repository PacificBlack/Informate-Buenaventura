...
public class Bienvenida extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList.add(new ItemInicio("Informate Buenaventura","Te damos la bienvenida a informate buenavenura, una app donde podrás enterarte de todo lo que pasa en el bello puerto del mar.",R.drawable.ic_ib_vector));
        mList.add(new ItemInicio("Adopciones","En esta sección podrás ver las publicaciones de los animales que se encuentren en adopción en nuestra ciudad.",R.drawable.ic_adopcion_vector));
        mList.add(new ItemInicio("Avisos Funebres","Aquí encontraras información acerca de personas que hayan fallecido recientemente. Así podrás enterarte, aunque no sean buenas noticias; siempre es mejor estar enterado para poder brindar apoyo.",R.drawable.ic_funebres_vector));
        mList.add(new ItemInicio("Bienes Raizes","En esta sección encontraras bienes muebles e inmuebles que se encuentren a la venta, podrás ver la información del vendedor para que contactes y compres aquello que deseas. Y si eres un vendedor, podrás ofrecer productos sin costos.",R.drawable.ic_bienes_vector));
        mList.add(new ItemInicio("Clasificados","Esta es una sección de publicidad, aquí podrás explorar y conocer negocios o trabajadores independientes que talvez aun no conozcas y te puedan interesar.",R.drawable.ic_clasificados_vector));
        mList.add(new ItemInicio("Compra y Venta","¿Tienes algo que no usas pero que si conservas en buen estado? ¡Ofrécelo aquí!, Las personas podrán ver aquello que publiques en esta sección y contactarte en caso de interés.",R.drawable.ic_comprayventa_vector));
        mList.add(new ItemInicio("Desaparecidos","Creo que se explica sola, como ya has de haber captado, aquí se mostraran aquellas personas que se han desaparecido, en cada publicación podrás ver la información de quien publicó, así si sabes algo, podrás contactarlo y darle información sobre aquel desaparecido.",R.drawable.ic_desaparecidos_vector));
        mList.add(new ItemInicio("Directorios","¿Recuerdas aquel “librito” amarillo donde podías encontrar resto de números telefónicos? Bueno, aquí una versión virtual, encontraras los números telefónicos de muchos lugares, desde comidas rápidas, hasta farmacias.",R.drawable.ic_directorio_vector));
        mList.add(new ItemInicio("Donaciones","Aquí podrás pedir ayuda si conoces algún caso de alguien que la necesite, podrás ver la información de quien publique para contactarlo en caso de que quieras donar algo y ayudar a quien lo necesite.",R.drawable.ic_donaciones_vector));
        mList.add(new ItemInicio("Eventos","Si quieres hacer un evento, concurso, etc. Puedes publicarlo y se verá aquí, así más gente sabrá y podrá participar o asistir a él. Entre más, mejor, ¿no?",R.drawable.ic_eventos_vector));
        mList.add(new ItemInicio("Noticias","En esta seccion estaras informado de todo lo que pasa en nuestro bello puerto",R.drawable.ic_noticias_vector));
        mList.add(new ItemInicio("Servicios","Aquí podrás encontrar publicaciones de trabajadores independientes o empresas que estén ofreciendo sus servicios. Como en cualquier de las otras secciones también puedes publicar, así que, si eres trabajador independiente en crecimiento, no dudes publicar.",R.drawable.ic_servicios_vector));
        mList.add(new ItemInicio("Empleos","Si estas en busca de empleo, esta sección te interesará bastante. Aquí podrás ver las publicaciones de diversas empresas que están en busca de empleador, asegúrate de leer bien sus requerimientos y si los cumples, ¡contáctalos! Puede ser tu oportunidad.",R.drawable.ic_empleo_vector));
