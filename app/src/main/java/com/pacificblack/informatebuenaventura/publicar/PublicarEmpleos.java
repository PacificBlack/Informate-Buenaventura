...
public class PublicarEmpleos extends AppCompatActivity {
    ...
    ImageView imagen1_publicar_empleos;

    TextInputLayout titulo_publicar_empleos,
            descripcioncorta_publicar_empleos;

    AutoCompleteTextView necesidad_publicar_empleos;

    Button publicarfinal_empleos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagen1_publicar_empleos = findViewById(R.id.publicar_imagen1_empleos);
        publicarfinal_empleos = findViewById(R.id.publicar_final_empleos);


        imagen1_publicar_empleos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == IMAGE_PICK_CODE1){
            ...
            imagen1_publicar_empleos.setImageURI(data.getData());
