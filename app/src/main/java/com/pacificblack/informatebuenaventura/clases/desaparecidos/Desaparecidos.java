...
public class Desaparecidos implements Serializable {
    ...
    public int getImagen1_desaparecidos() {
        return imagen1_desaparecidos;
    }

    public void setImagen1_desaparecidos(int imagen1_desaparecidos) {
        this.imagen1_desaparecidos = imagen1_desaparecidos;
    }

    public int getImagen2_desaparecidos() {
        return imagen2_desaparecidos;
    }

    public void setImagen2_desaparecidos(int imagen2_desaparecidos) {
        this.imagen2_desaparecidos = imagen2_desaparecidos;
    }

    public int getImagen3̣̣_desaparecidos() {
        return imagen3̣̣_desaparecidos;
    }

    public void setImagen3̣̣_desaparecidos(int imagen3̣̣_desaparecidos) {
        this.imagen3̣̣_desaparecidos = imagen3̣̣_desaparecidos;
    }
